...
public class PageNavigate {
     ...
     * 箭头分页，只显示上一页下一页
     */
    public static final int ARROW_MODEL = 3;
    /**
     * 页码显示模型
     */
    private int model = 2;
    ...
    private void buildNumModel() {
        ...
        if (recordCount != 0) {
            strHtml.append("<div class=\"col-xs-6 text-left\" style=\"width:auto;padding-right:0\"><ul class=\"pagination\" style=\"margin:0\">");
            ...
            strHtml.append("<div class=\"col-xs-6 maringTop10\" style=\"color:#aaaaaa;padding-left:0\"></div>");
        }
        if (recordCount == 0)
            strHtml.append("<div class=\"col-xs-12 maringTop10 \">没有数据</div>");
        else
            strHtml.append("<div class=\"col-xs-6 maringTop10\" style=\"color:#aaaaaa;padding-left:0\">当前显示").append(calCurShow(currentPage, pageSize, recordCount, countPage)).append("条,共").append(recordCount)
                    .append("条记录</div>");
    }
    ...
    private void buildArrowModel() {
        int currentPage = pageIndex > countPage ? 1 : pageIndex;
        strHtml.append("<table width='100%'  border='0' cellspacing='0' cellpadding='0'>").append("<tr>&nbsp;&nbsp;");
        if (currentPage > 1) {
            strHtml.append("<a class='btn' href='").append(url).append(currentPage - 1).append("'>️<i class=\"fa fa-arrow-circle-left\"></i></a>");
        } else {
            strHtml.append("<a class='btn' disabled href='javascript:void(0);'><i class=\"fa fa-arrow-circle-left\"></i>️</a>");
        }
        if (currentPage < countPage) {
            strHtml.append("&nbsp;&nbsp;&nbsp;<a class='btn' href='").append(url).append(currentPage + 1).append("'><i class=\"fa fa-arrow-circle-right\"></i></a>");
        } else {
            strHtml.append("&nbsp;&nbsp;&nbsp;<a class='btn' disabled href='javascript:void(0);'><i class=\"fa fa-arrow-circle-right\"></i></a>");
        }
        strHtml.append("</td></tr></table>");
    }
